...
function CreateUser() {
  ...
  async function handleSubmit(e) {
    e.preventDefault()
    let { data } = await axios.post('http://localhost:8888/admin/create-user',
          ...
          <MDBCol md='6' className='position-relative'>
            ...
            <MDBCard className='my-5 bg-glass'>
              <MDBCardBody className='p-5'>
                ...
                <MDBBtn onClick={handleSubmit} className='w-100 mb-4' size='md' style={{backgroundColor:'#870ccfd4'}}>Create</MDBBtn>
